...
export function whenParamEquals(
  paramKey: string,
  value: unknown
...
export function whenParamNotEquals(
  paramKey: string,
  value: unknown
): (params: Record<string, unknown>) => boolean {
  return (params) => params[paramKey] !== value
...
const baseNodes: Record<string, NodeDefinition> = {
  ...
  wait: {
    ...
    label: 'Wait',
    category: 'flow',
    fields: [{ key: 'seconds', label: 'Seconds', type: 'number', step: 0.1, defaultValue: 1 }],
  ...
  actor_create: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Copy From',
        type: 'searchable',
        placeholder: 'player / actor key (optional)',
        options: []
      },
      { key: 'x', label: 'X', type: 'number', defaultValue: 0 },
      { key: 'y', label: 'Y', type: 'number', defaultValue: 0 }
  ...
  attach_to_target: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Duration (seconds, 0=instant)',
        type: 'number',
        step: 0.1,
        defaultValue: 0
      },
  ...
  lerp: {
    ...
    fields: [
      { key: 'target', label: 'Target', type: 'searchable', options: [] },
      {
        ...
        label: 'Property',
        type: 'searchable',
        options: ['x', 'y', 'image_xscale', 'image_yscale', 'image_angle', 'image_alpha', 'depth'],
        defaultValue: 'x'
      },
  ...
  set_emotion: {
    ...
    fields: [
      { key: 'target', label: 'Target', type: 'searchable', options: [] },
      {
        ...
        label: 'Emotion',
        type: 'searchable',
        options: ['neutral', 'happy', 'sad', 'angry', 'surprised', 'custom'],
      ...
      },
      {
        ...
        label: 'Blend Color',
        type: 'searchable',
        options: ['c_white', 'c_red', 'c_blue', 'c_green', 'c_yellow'],
        defaultValue: 'c_white'
      }
    ],
  ...
  wait_for_dialogue: {
    ...
    label: 'Wait For Dialogue',
    category: 'dialogue',
    fields: [
      {
        key: 'dialogue_controller',
        label: 'Dialogue Controller (optional)',
        type: 'text',
        placeholder: 'instance ref / leave empty for active textbox',
        defaultValue: ''
      }
    ],
...
const cameraNodes: Record<string, NodeDefinition> = {
  ...
  camera_track_until_stop: {
    type: 'camera_track_until_stop',
    label: 'Camera Track Until Stop',
    category: 'camera',
    fields: [
      {
        key: 'target',
  ...
  tween: {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: 'actor key / player',
        options: [],
        condition: whenParamNotEquals('kind', 'camera')
      },
      {
        key: 'prop',
        label: 'Property',
        type: 'searchable',
        placeholder: 'x, y, image_alpha...',
        options: [
          'x',
          'y',
          'image_alpha',
...
const otherNodes: Record<string, NodeDefinition> = {
  ...
  stop_music: {
    ...
    label: 'Stop Music',
    category: 'audio',
    fields: [{ key: 'fade', label: 'Fade Out (sec)', type: 'number', step: 0.1, defaultValue: 1 }],
  ...
  music_unduck: {
    ...
    label: 'Music Unduck',
    category: 'audio',
    fields: [{ key: 'fade', label: 'Fade (sec)', type: 'number', step: 0.1, defaultValue: 0.3 }],
    defaultParams: { fade: 0.3 }
  },
  music_pitch: {
    type: 'music_pitch',
    label: 'Music Pitch (Playback Speed)',
    category: 'audio',
    fields: [
      {
        key: 'pitch',
  ...
  stop_boss_music: {
    ...
    label: 'Stop Boss Music',
    category: 'audio',
    fields: [{ key: 'fade', label: 'Fade Out (sec)', type: 'number', step: 0.1, defaultValue: 1 }],
    defaultParams: { fade: 1 }
  },
  boss_music_phase: {
    type: 'boss_music_phase',
    label: 'Boss Music Phase',
    category: 'audio',
    fields: [
      {
        key: 'phases',
        ...
        type: 'json',
        placeholder:
          '[{"intro":"snd_intro","calm":"snd_calm","battle":"snd_battle","intensity":0,"fade":0.5}]',
        defaultValue: ''
      },
  ...
  play_music_intro: {
    type: 'play_music_intro',
    label: 'Play Music Intro',
    category: 'audio',
    fields: [
      {
        key: 'intro',
  ...
  play_music_intro_layered: {
    type: 'play_music_intro_layered',
    label: 'Play Intro Layered',
    category: 'audio',
    fields: [
      {
        key: 'intro',
  ...
  crossfade_music: {
    ...
    label: 'Crossfade Music',
    category: 'audio',
    fields: [
      {
        key: 'intensity',
        label: 'Intensity (0=calm, 1=battle)',
        type: 'number',
        step: 0.1,
        defaultValue: 0.5
      },
  ...
  partial_control: {
    ...
    fields: [
      ...
      {
        key: 'whitelist',
        label: 'Whitelist (JSON array)',
        type: 'json',
        placeholder: '["obj_door", "obj_chest"]',
        defaultValue: ''
      }
    ],
    ...
    fields: [
      {
        ...
        label: 'Target',
        type: 'searchable',
        placeholder: 'actor key / object',
        options: []
      },
      {
        key: 'timeout',
        label: 'Timeout (seconds, 0=never)',
        type: 'number',
        step: 0.1,
        defaultValue: 0
      },
      {
        ...
        label: 'On Timeout',
        type: 'select',
        options: ['continue', 'abort_parallel'],
  ...
  move_relative_direction: {
    type: 'move_relative_direction',
    label: 'Move Relative Direction',
    category: 'movement',
    fields: [
      {
        key: 'target',
      ...
      { key: 'seconds', label: 'Duration (seconds)', type: 'number', step: 0.1, defaultValue: 1 },
      {
        key: 'collision',
        label: 'Collision',
        type: 'select',
  ...
  schedule_action: {
    ...
    fields: [
      ...
      },
      {
        ...
        defaultValue: 'play_sfx'
      },
      {
        key: 'action_params',
        label: 'Action Params (JSON)',
        type: 'json',
        placeholder: '{"target":"player","sprite":"spr_heart"}',
        defaultValue: ''
      },
      {
        key: 'blocking',
        label: 'Blocking (wait for inner)',
        type: 'checkbox',
        defaultValue: false
      },
      {
  ...
  checkpoint_state: {
    ...
    fields: [
      ...
      {
        key: 'include_globals',
        label: 'Include Globals (JSON array)',
        type: 'text',
        defaultValue: ''
      },
      {
        key: 'include_instances',
        label: 'Include Instances (JSON array)',
        type: 'text',
        defaultValue: ''
      }
    ],
  ...
  restore_state: {
    ...
    fields: [
      { key: 'checkpoint_id', label: 'Checkpoint ID', type: 'text', defaultValue: '' },
      {
        key: 'cleanup_transients',
        label: 'Cleanup Transients',
        type: 'checkbox',
        defaultValue: true
      },
  ...
  parallel_start: {
    ...
    category: 'logic',
    fields: [],
    defaultParams: { branches: ['b0'], joinId: '' }
  },
  parallel_join: {
    type: 'parallel_join',
    label: 'Parallel Join',
    category: 'logic',
    fields: [{ key: 'pairId', label: 'Pair Start Node ID', type: 'text', defaultValue: '' }],
    defaultParams: { pairId: '' }
  },
  // Dialogue integration nodes.
  set_dialogue_speed: {
    type: 'set_dialogue_speed',
    label: 'Set Dialogue Speed',
    category: 'dialogue',
    fields: [{ key: 'speed', label: 'Chars/sec', type: 'number', step: 0.1, defaultValue: 1.0 }],
  ...
  set_portrait_next: {
    type: 'set_portrait_next',
    label: 'Set Portrait Next',
    category: 'dialogue',
    fields: [
      {
        key: 'target',
      ...
      },
      {
        ...
        label: 'Emotion',
        type: 'select',
        options: ['neutral', 'angry', 'sad', 'scared', 'happy', 'confused', 'surprised'],
        defaultValue: 'neutral'
      }
    ],
  ...
  set_portrait_now: {
    type: 'set_portrait_now',
    label: 'Set Portrait Now',
    category: 'dialogue',
    fields: [
      {
        key: 'target',
  ...
  room_change: {
    ...
    fields: [
      ...
      {
        key: 'actors',
        label: 'Actor Positions (JSON)',
        type: 'json',
        placeholder: '{"npc1":{"x":100,"y":200}}'
      }
    ],
    defaultParams: { room: '', player_x: 0, player_y: 0, actors: '' }
  }
}
