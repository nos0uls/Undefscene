...
export const en = {
  ...
  editor: {
    ...
    expandLeftDock: 'Expand left dock',
    collapseLeftDock: 'Collapse left dock',
    expandRightDock: 'Expand right dock',
    collapseRightDock: 'Collapse right dock',
    expandBottomDock: 'Expand bottom dock',
  ...
  nodes: {
    ...
    fields: {
      ...
      target_ref: 'Target',
      parent_ref: 'Parent',
      follow_facing: 'Follow Facing',
      follow_scale: 'Follow Scale',
      follow_depth: 'Follow Depth',
      duration_seconds: 'Duration (seconds, 0=instant)',
      detach_on_cutscene_end: 'Detach On Cutscene End',
      keep_world_position: 'Keep World Position',
      destroy_after_detach: 'Destroy After Detach',
      property: 'Property',
      factor: 'Factor (0..1)',
      emotion: 'Emotion',
      blend: 'Blend Color',
      block_queue: 'Block Queue',
      duration_frames: 'Seconds',
      ease_name: 'Easing',
      smooth: 'Smooth',
      ...
      timeout_seconds: 'Timeout (seconds, 0=no timeout)',
      var: 'Global Var',
      equals: 'Equals',
      if_false: 'If False',
      ...
      stop_when: 'Stop When',
      end_var: 'End Var',
      end_equals: 'End Equals',
      end_node: 'End Node',
      end_timeout: 'End Timeout (seconds)',
      dx: 'dX',
      dy: 'dY',
    ...
    preview: {
      ...
      direction: 'dir:',
      depth: 'depth:',
      activeTextbox: 'active textbox',
      charsPerSec: 'ch/s',
      waitForTyping: 'wait for typing',
      noSkip: 'no skip',
      stayOpen: 'stay open',
  ...
  toasts: {
    ...
    screenshotDirUpdated: 'Screenshot output directory updated',
    screenshotDirUpdateFailed: 'Failed to update screenshot directory',
    devDataCleaned: 'Development data cleaned',
    devDataCleanupFailed: 'Failed to cleanup development data'
  },
  ...
  dialog: {
    ...
    cleanupDevDataTitle: 'Cleanup development data',
    cleanupDevDataMessage: 'This will delete all temporary development data. Are you sure?'
  },
  ...
  validation: {
    ...
    playMusicIntroNoLoop: '{name}: loop track not selected.',
    ...
    emoteMissingSprite: '{name}: sprite is empty. Select a sprite for the emote.',
    jumpInvalidSeconds: '{name}: seconds must be a positive number.',
